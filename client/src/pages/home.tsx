      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div>
            ...
            {/* Second chunk of surahs */}
            {!isLoading && filteredSurahs && filteredSurahs.length > 12 && (
              <div className="md:grid md:grid-cols-2 md:gap-3">
            ...
            {/* Third chunk of surahs */}
            {!isLoading && filteredSurahs && filteredSurahs.length > 36 && (
              <div className="md:grid md:grid-cols-2 md:gap-3">
