 ...
 * This standalone file replaces the need for TypeScript in production
 */
...
console.log('Connecting to database with URL:', connectionString.replace(/:.+@/, ':****@')); // Log URL with password hidden
let sql;
try {
  sql = postgres(connectionString, { 
    ...
    debug: (conn, query, params) => {
      console.log('SQL Query:', query.split('\n')[0].substring(0, 80) + '...'); 
    },
