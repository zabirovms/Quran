...
const pageSeoData = {
  ...
  'farzi-ayn': {
    title: 'Фарзи Айн - Ҳуқуқи шахсӣ дар ислом | Қуръони Карим',
    description: 'Омӯхтани фарзи айн дар ислом, ҳуқуқи шахсӣ, вазифаҳо ва масъулиятҳои мусулмон.',
    keywords: 'фарзи айн, ҳуқуқи шахсӣ, ислом, вазифаҳо, масъулиятҳо, точики, қуръони карим'
  }
};
